  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-end sm:items-center justify-center" role="dialog" aria-modal="true" aria-label="Respond to requirement">
      ...
      <div className="relative w-full sm:max-w-[420px] bg-canvas rounded-t-[20px] sm:rounded-[20px] shadow-airbnb border border-hairline-soft p-6 animate-fade-up">
        ...
        {!isAgent && (
          <div className="flex items-center gap-3 mb-5 p-3 rounded-[14px] bg-surface-soft border border-hairline">
            <span className="shrink-0 text-[15px] font-bold text-ink bg-[#eab308] rounded-full w-12 h-12 flex items-center justify-center tabular-nums">{score}%</span>
        ...
        <button type="button"
          ...
          className="w-full h-12 bg-ink text-white text-base font-semibold rounded-[8px] hover:bg-black transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink focus-visible:ring-offset-2">
